...
// Original file's copyright note:
...
// Modified to output int16 to not waste RAM in the case of huge files.
...
{
    public static class WavFileInt16Mod
    {
        ...
        public static (int sampleRate, Int16[] L) ReadMono(string filePath)
        {
            (int sampleRate, Int16[] L, _) = ReadStereo(filePath);
            return (sampleRate, L);
        }

        public static (int sampleRate, Int16[] L, Int16[] R) ReadStereo(string filePath)
        {
